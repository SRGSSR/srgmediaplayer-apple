...
- (void)testVisibleSegments
{
    ...
    [self.mediaPlayerController playURL:SegmentsTestURL()
                                 atTime:kCMTimeZero
...
- (void)testStartTimeInSegmentWithoutSelection
{
    ...
    [self.mediaPlayerController playURL:SegmentsTestURL()
                                 atTime:CMTimeMakeWithSeconds(30., NSEC_PER_SEC)
                    withToleranceBefore:kCMTimeZero
                         toleranceAfter:kCMTimeZero
                               segments:@[segment]
                               userInfo:nil];
...
- (void)testStartTimeInSegmentWithSelection
{
    ...
    [self.mediaPlayerController playURL:SegmentsTestURL()
                                atIndex:0 time:CMTimeMakeWithSeconds(10., NSEC_PER_SEC)
                             inSegments:@[segment]
                    withToleranceBefore:kCMTimeZero
                         toleranceAfter:kCMTimeZero
                               userInfo:nil];
...
- (void)testStartTimeAterSegmentWithSelection
{
    ...
    [self.mediaPlayerController playURL:SegmentsTestURL()
                                atIndex:0
                                   time:CMTimeMakeWithSeconds(200., NSEC_PER_SEC)
                             inSegments:@[segment]
                    withToleranceBefore:kCMTimeZero
                         toleranceAfter:kCMTimeZero
                               userInfo:nil];
...
- (void)testPrepareToPlaySegmentAtIndex
{
    ...
    [self.mediaPlayerController prepareToPlayURL:SegmentsTestURL()
                                         atIndex:0
                                            time:kCMTimeZero
                                      inSegments:@[segment]
                             withToleranceBefore:kCMTimeZero
