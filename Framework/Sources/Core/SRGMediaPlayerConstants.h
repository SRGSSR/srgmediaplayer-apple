...
OBJC_EXPORT NSString * const SRGMediaPlayerPreviousTimeKey;                                 // Key to an `NSValue` wrapping a `CMTime` specifying the previous playback position before a (discontinuous) segment transition occurred.
